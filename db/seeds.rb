Recipe.find_or_create_by(name:"Ham and Cheese", ingredients:"Ham, Cheese, Bread", calories: 352, user: "Steve")
Recipe.find_or_create_by(name:"Lo Mein", ingredients:"thick noodles, soy sauce", calories: 300, user: "Marsha")
